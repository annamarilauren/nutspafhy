...
class CanopyGrid():
    def __init__(self, cpara, state, outputs=False):
        ...
        self.hc = cpara['state']['hc'] + epsi
        self.cf = cpara['state']['cf'] + epsi
        ...
        self._LAIconif = cpara['state']['lai_conif'] + epsi # m2m-2
        self._LAIdecid = cpara['state']['lai_decid_max']*self.phenopara['lai_decid_min'] + epsi
        self.LAI = self._LAIconif + self._LAIdecid

        self._LAIdecid_max = cpara['state']['lai_decid_max'] + epsi # m2m-2        
        ...
        # --- state variables
        self.W = np.minimum(cpara['state']['w'], self.wmax*self.LAI)
        self.SWE = cpara['state']['swe']
        self.SWEi = self.SWE
